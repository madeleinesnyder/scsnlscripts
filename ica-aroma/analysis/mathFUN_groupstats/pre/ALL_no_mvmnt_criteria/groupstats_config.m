...
paralist.subjlist_file = {'ASD25.txt'};  

% Please specify the stats folder path
paralist.stats_folder  = 'stats_spm8_comparison_5cond_modeling_CandB_SM';

% Plese specify the folder path to put analysis results
paralist.output_folder = '/mnt/apricot1_share1/MathFUN_ASD/Sam_Preprocessing/groupstats/ASD';
