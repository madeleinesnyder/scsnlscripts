...
% Stanford, USA
function [BDS,stats] = main_MDS_estimation_ox(timeseries,stim_design,o)
TR = o.TR;
tol = o.tol;
maxIter = o.maxIter;

Vm = permute(stim_design, [2, 1, 3]);
% Vm(:,2) = 1-stim_design';
...
[M N,S] = size(Y); % M: region number N: time length
v = zeros(N,1,1);  % External stimulus
%v = 1-stim_design;
cnt = 1;
%     S = 1;
for s = 1:S
