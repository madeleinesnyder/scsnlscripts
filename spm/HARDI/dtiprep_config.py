'''
Config file for dti prep, a pipeline for processing dti data designed by John Kochalka based on fmriprep from the Poldrack lab
...
job_output = project_dir+'/Jobs/dtiprep-%j.out'

# Where to save error files from each job
job_error = project_dir+'/Jobs/dtiprep-%j.err'
...
run_script(config_args,slurm_args,'dtiprep')
