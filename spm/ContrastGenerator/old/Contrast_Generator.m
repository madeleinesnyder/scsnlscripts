...
nCon = paralist.numcontrasts
nSess = paralist.numsessions
comWithinSess = paralist.comparewithin
movFill = paralist.movementcorrection
contrastNames = paralist.contrastnames
contrast = paralist.contrast
