...
function preprocessfmri_PD(ConfigFile)

CurrentDir = pwd;

disp('==================================================================');
fprintf('Current directory: %s\n', CurrentDir);
fprintf('Script: %s\n', which('preprocessfmri_PD.m'));
    ...
    for cnt = 1:nstep
      ...
      switch p
        ...
        case 'a'
          ...
          preprocessfmri_slicetime(WholePipeLine, TemplatePath, InputImgFile, FlipFlag, PfileDir, TempDir);
