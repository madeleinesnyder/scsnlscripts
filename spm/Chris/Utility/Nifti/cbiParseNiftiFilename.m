function [pathstr,imgname,hdrname,ext,ver,compext,iscomp,ishdrcomp]=cbiParseNiftiFilename(fname,checkfileexists)
% [pathstr,imgname,hdrname,ext,ver,compext,iscomp,ishdrcomp]=cbiParseNiftiFilename(fname,checkfileexists)
%
%
