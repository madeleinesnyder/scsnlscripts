function varargout = cbiReadNiftiHeader(fname)
% hdr = cbiReadNiftiHeader(fname)         Reads header and closes file
% [hdr,zid] = cbiReadNiftiHeader(fname)   Reads header and returns file pointer for single files only
% 
...
[pathstr,imgname,hdrname,ext,ver,compressext,iscompressed,hdriscompressed]=cbiParseNiftiFilename(fname,1);
