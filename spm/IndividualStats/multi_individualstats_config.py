...
subjectlist = ['/oak/stanford/groups/menon/projects/mcsnyder/PID_project/data/subjectlist/subjectlist.csv',
	       '/oak/stanford/groups/menon/projects/mcsnyder/PID_project/data/subjectlist/subjectlist.csv',]

# Please specify the .txt file with your sessions
runlist = '/oak/stanford/groups/menon/projects/mcsnyder/PID_project/data/subjectlist/runlist.txt'
...
job_name = 'multi_individualstats'

# Where to save output files from each job
job_output = project_dir+'/Jobs/multi_individualstats-%j.out'

# Where to save error files from each job
job_error = project_dir+'/Jobs/multi_individualstats-%j.err'
...
run_script(config_args,slurm_args,'multi_individualstats')
