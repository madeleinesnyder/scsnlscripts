...
subjectlist = ['/scratch/PI/menon/projects/chamblin/text_lists/preMD.txt',
	       '/scratch/PI/menon/projects/chamblin/text_lists/postMD.txt']
...
taskdesign_file = 'task_design_test.m'
