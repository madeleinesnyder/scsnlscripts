...
% GLOBAL : 1 when the roi timeseries, global timeseries and
%            movement covariates are all used as a regressor
%-08/10/2015 add option 2
% GLOBAL : 2 when the roi timeseries, wm timeseries, csf timeseries and
%            movement covariates are all used as regressors
