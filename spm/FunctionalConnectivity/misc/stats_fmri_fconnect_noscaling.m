...
%-TC: 07/21/2015: add TR_val option as one of the parameters

function stats_fmri_fconnect_noscaling (datadir, data_type, NUMTRUNC, imagefilter, TR_val)
...
load('/home/groups/menon/oak/scsnlscripts/spm/BatchTemplates/batch_stats.mat');

% Update TR
matlabbatch{1}.spm.stats.fmri_spec.timing.RT = TR_val; 
